...
const s = StyleSheet.create({
  ...
  gridH: { position: 'absolute', left: 0, right: 0, height: 0.5, backgroundColor: '#0D1526' },
  gridV: { position: 'absolute', top: 0, bottom: 0, width: 0.5, backgroundColor: '#0D1526' },
  ...
  heroCounter: { fontSize: 72, fontWeight: '900', color: '#fff', lineHeight: 76, letterSpacing: -3 },
  heroCounterSub: { fontSize: 14, color: '#4B5563', marginBottom: 20 },
  heroTitle: { fontSize: 38, fontWeight: '900', color: '#fff', lineHeight: 44, marginBottom: 10, letterSpacing: -1 },
  heroSub: { fontSize: 15, color: '#4B5563', lineHeight: 24, marginBottom: 28 },
  ...
  heroLoginText: { color: '#4B5563', fontSize: 13 },
