...
const s = StyleSheet.create({
  ...
  activeStatus: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#FFF1F1', borderRadius: 20, overflow: 'hidden', paddingHorizontal: 16, paddingVertical: 8, borderWidth: 1, borderColor: colors.emergency, marginBottom: 24 },
  ...
  activeDogPhotoPlaceholder: { width: 120, height: 120, borderRadius: 60, overflow: 'hidden', backgroundColor: '#FFF1F1', alignItems: 'center', justifyContent: 'center', borderWidth: 3, borderColor: colors.emergency, marginBottom: 12 },
  ...
  notifiedCard: { backgroundColor: '#FFF1F1', borderRadius: 16, overflow: 'hidden', borderWidth: 1, borderColor: colors.emergency + '60', paddingVertical: 14, paddingHorizontal: 40, alignItems: 'center', marginBottom: 20, width: '100%' },
  ...
  backHomeBtnText: { color: '#64748B', fontSize: 13 },
});
