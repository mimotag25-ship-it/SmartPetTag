...
const s = StyleSheet.create({
  ...
  alertBtnText: { color: '#FFFFFF', fontWeight: '900', fontSize: 15, textAlign: 'center' },
  alertBtnHint: { textAlign: 'center', fontSize: 12, color: colors.textMuted, marginTop: 8 },
  activeContainer: { flex: 1, backgroundColor: '#FFF5F5' },
  ...
  activeStatus: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#FEF2F2', borderRadius: 20, overflow: 'hidden', paddingHorizontal: 16, paddingVertical: 8, borderWidth: 1, borderColor: colors.emergency, marginBottom: 24 },
  ...
  activeDogPhotoPlaceholder: { width: 120, height: 120, borderRadius: 60, overflow: 'hidden', backgroundColor: '#FEF2F2', alignItems: 'center', justifyContent: 'center', borderWidth: 3, borderColor: colors.emergency, marginBottom: 12 },
  activeDogName: { fontSize: 30, fontWeight: '900', color: '#FFFFFF', letterSpacing: -1 },
  activeDogBreed: { fontSize: 14, color: colors.textMuted, marginBottom: 4 },
  activeDogLocation: { fontSize: 13, color: colors.textSecondary },
  notifiedCard: { backgroundColor: '#FEF2F2', borderRadius: 16, overflow: 'hidden', borderWidth: 1, borderColor: colors.emergency + '60', paddingVertical: 14, paddingHorizontal: 40, alignItems: 'center', marginBottom: 20, width: '100%' },
  ...
  sightingCard: { backgroundColor: '#ECFDF5', borderRadius: 12, overflow: 'hidden', borderWidth: 0.5, borderColor: '#10B981' + '60', padding: 14, width: '100%', marginBottom: 8 },
  ...
  whatsappShareBtn: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: '#ECFDF5', borderRadius: 14, overflow: 'hidden', borderWidth: 1, borderColor: '#10B981' + '60', padding: 14, width: '100%', marginBottom: 10 },
  ...
  whatsappLogoText: { color: '#FFFFFF', fontSize: 13, fontWeight: '900' },
  whatsappShareTitle: { fontSize: 14, fontWeight: '700', color: '#FFFFFF', marginBottom: 2 },
  ...
  posterTitle: { fontSize: 14, fontWeight: '700', color: '#FFFFFF', marginBottom: 2 },
  posterSub: { fontSize: 11, color: colors.textMuted },
  foundBtn: { backgroundColor: '#ECFDF5', borderRadius: 14, overflow: 'hidden', borderWidth: 1, borderColor: '#10B981', paddingVertical: 14, alignItems: 'center', width: '100%' },
  foundBtnText: { color: '#10B981', fontWeight: '700', fontSize: 14 },
  foundScreen: { flex: 1, backgroundColor: '#ECFDF5', alignItems: 'center', justifyContent: 'center', padding: 28 },
  confettiPiece: { position: 'absolute' },
  foundContent: { alignItems: 'center' },
  foundAvatarWrap: { width: 140, height: 140, borderRadius: 70, overflow: 'hidden', borderWidth: 3, borderColor: '#10B981', marginBottom: 20, backgroundColor: '#ECFDF5', alignItems: 'center', justifyContent: 'center' },
  foundPhoto: { width: '100%', height: '100%' },
  foundTitle: { fontSize: 26, fontWeight: '900', color: '#FFFFFF', textAlign: 'center', marginBottom: 8, letterSpacing: -0.5 },
  ...
  foundShareBtnText: { color: '#ECFDF5', fontWeight: '800', fontSize: 15 },
  backHomeBtn: { paddingVertical: 12 },
  backHomeBtnText: { color: '#9CA3AF', fontSize: 13 },
});
