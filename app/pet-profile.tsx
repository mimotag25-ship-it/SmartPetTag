...
const s = StyleSheet.create({
  ...
  badge: { flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 20, borderWidth: 0.5 },
  badgeIcon: { fontSize: 13 },
  badgeText: { fontSize: 11, fontWeight: '600' },
  section: { marginHorizontal: 16, marginBottom: 12, backgroundColor: colors.bgCard, borderRadius: 16, borderWidth: 0.5, borderColor: colors.bgBorder, overflow: 'hidden' },
  ...
  tag: { backgroundColor: colors.bgBorder, borderRadius: 20, paddingHorizontal: 12, paddingVertical: 6 },
  tagText: { fontSize: 12, color: colors.textSecondary, fontWeight: '500' },
  noteCard: { margin: 14, backgroundColor: colors.bg, borderRadius: 10, padding: 14, borderWidth: 0.5, borderColor: colors.bgBorder },
