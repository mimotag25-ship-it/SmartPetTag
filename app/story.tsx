...
const styles = StyleSheet.create({
  ...
  storyDogName: { fontSize: 14, fontWeight: '700', color: '#FFFFFF' },
  ...
  storyCaption: { color: '#FFFFFF', fontSize: 15, textAlign: 'center', lineHeight: 22 },
  createScreen: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 12 },
  createEmoji: { fontSize: 64 },
  createTitle: { fontSize: 24, fontWeight: '700', color: '#FFFFFF' },
  ...
  pickPhotoBtnText: { color: '#FFFFFF', fontWeight: '700', fontSize: 16 },
  previewWrap: { flex: 1 },
  previewImage: { width: '100%', height: '100%', position: 'absolute' },
  captionWrap: { position: 'absolute', bottom: 120, left: 16, right: 16 },
  captionInput: { color: '#FFFFFF', fontSize: 18, textAlign: 'center', textShadowColor: 'rgba(0,0,0,0.8)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 4 },
  ...
  retakeBtnText: { color: '#FFFFFF', fontWeight: '600', fontSize: 14 },
