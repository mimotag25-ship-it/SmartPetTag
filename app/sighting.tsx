...
const styles = StyleSheet.create({
  ...
  urgentText: { color: '#FFFFFF', fontSize: 12, fontWeight: '800', letterSpacing: 1 },
  ...
  dogName: { fontSize: 22, fontWeight: '800', color: '#FFFFFF', marginBottom: 4 },
  ...
  form: { padding: 20 },
  formTitle: { fontSize: 20, fontWeight: '700', color: '#FFFFFF', marginBottom: 6 },
  ...
  input: { backgroundColor: '#0d0d0d', borderWidth: 0.5, borderColor: '#222', borderRadius: 12, padding: 14, fontSize: 14, color: '#FFFFFF', marginBottom: 16 },
