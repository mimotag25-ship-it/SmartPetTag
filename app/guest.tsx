...
const styles = StyleSheet.create({
  ...
  logo: { fontSize: 28, fontWeight: '800', color: '#fff', fontStyle: 'italic', marginBottom: 8 },
  ...
  alertDogName: { fontSize: 15, fontWeight: '700', color: '#fff', marginBottom: 2 },
  ...
  alertBadgeText: { fontSize: 10, color: '#fff', fontWeight: '800', letterSpacing: 1 },
  ...
  ctaTitle: { fontSize: 20, fontWeight: '800', color: '#fff', marginBottom: 6, textAlign: 'center' },
  ...
  signupBtnText: { color: '#050508', fontWeight: '800', fontSize: 16 },
