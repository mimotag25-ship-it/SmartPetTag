...
const s = StyleSheet.create({
  ...
  whatsappBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#ECFDF5', borderRadius: 12, borderWidth: 0.5, borderColor: '#10B981', paddingVertical: 12 },
  whatsappLogo: { width: 20, height: 20, borderRadius: 10, backgroundColor: '#25D366', alignItems: 'center', justifyContent: 'center' },
  whatsappLogoText: { color: '#FFFFFF', fontSize: 11, fontWeight: '900' },
  whatsappBtnText: { color: '#10B981', fontSize: 13, fontWeight: '600' },
  inAppMsgBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#EEF2FF', borderRadius: 12, borderWidth: 0.5, borderColor: '#6366F1', paddingVertical: 12 },
  ...
  chatNowBtnText: { color: '#FFFFFF', fontWeight: '800', fontSize: 15 },
});
