...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 14, color: '#FFFFFF', fontWeight: '600', marginHorizontal: 16, marginBottom: 4 },
  ...
  optionLabelActive: { color: '#FFFFFF', fontWeight: '500' },
  ...
  doneTitle: { fontSize: 28, fontWeight: '700', color: '#FFFFFF', marginBottom: 10 },
